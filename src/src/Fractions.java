...
public class Fractions {
    public int numerator; // поле числителя
    public int denominator; // поле знаменателя
    ...
    public static void showReduction(String a, Fractions obj) {
    ...
    public static void show(Fractions obj) {
    ...
    public static void to_normal(Fractions obj) {
